(function(){
  ...
  // Hide body immediately via CSS injection (body doesn't exist yet in <head>)
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    ov.innerHTML = [
      '<div class="lg-box">',
      '  <div class="lg-logo"><img src="img/logo-bunker.png" alt="BUNKER"></div>',
      '  <div class="lg-tag">SYSTEM V2.0 — ACCESO RESTRINGIDO</div>',
      '  <form id="lg-form" autocomplete="off">',
      '    <div class="lg-field">',
      '      <label>USUARIO</label>',
      '      <input type="text" id="lg-user" autocomplete="off" spellcheck="false">',
      '    </div>',
      '    <div class="lg-field">',
    ...
    st.textContent = [
      ...
      '.lg-logo img{height:50px;margin-bottom:1.5rem;filter:brightness(0) invert(1);opacity:.8;}',
